package testdbms;
import testdbms.NewOfficerRegistration;
...
public class Officerlogin {
	...
	private void initialize() throws ClassNotFoundException, SQLException {
		...
		JLabel lblCrimeInvestigationSystem = new JLabel("PUBLIC SAFETY PLATFORM ");
...
////		Image im = new ImageIcon(this.getClass().getResource("images/officer-logo.jpg")).getImage();
